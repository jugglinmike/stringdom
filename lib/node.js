...
/**
 * Lookup table for tanslating DOM Level 0 "nodeType" to HtmlParser2 "type"
 * attribute value.
 */
var typeTable = Object.create(null);
typeTable[1] = 'tag';
typeTable[3] = 'text';
typeTable[8] = 'comment';
...
// Define non-standard aliases for compatability with CSSSelect
...
Object.defineProperty(Node.prototype, 'type', {
	get: function() {
		return typeTable[this.nodeType];
	}
});
