...
// upstream.
var domUtilsType = null;
var domSerializerType = null;

try {
  domUtilsType = require(
    'css-select/node_modules/domutils/node_modules/domelementtype'
  );
  domSerializerType = require('dom-serializer/node_modules/domelementtype');
}
catch (unhandledException) {
  domUtilsType = require('domelementtype');
  domSerializerType = require('dom-serializer/node_modules/domelementtype');
}

domUtilsType.isTag = domSerializerType.isTag = function(elem) {
